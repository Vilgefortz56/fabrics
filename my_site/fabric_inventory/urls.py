...
urlpatterns = [
    ...
    path('get_fabric_materials/<int:fabric_view_id>/', views.get_fabric_materials, name='get_fabric_materials'),
    path('get-fabric-views/', views.get_fabric_views_ajax, name='get_fabric_views_ajax'),
    path('get-fabric-materials/', views.get_fabric_materials_ajax, name='get_fabric_materials_ajax'),
